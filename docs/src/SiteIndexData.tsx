...
const indexData = new IndexData([
    ...
    new IndexEntry("add_child_window", [
        new IndexReference(
            `/apis/classes/NWindow`, 
            `4.7.X - NWindow`, 
            `method void NWindow::add_child_window(NWindow::ptr child)`, 
            `method__NWindow_add_child_window`),
    ]),
    ...
    new IndexEntry("create", [
        ...
        new IndexReference(
            `/apis/classes/NMenuElement`, 
            `4.7.X - NMenuElement`, 
            `method static NMenuElement::ptr NMenuElement::create(const std::string& label, const std::vector<NMenuItem>& items)`, 
            `method__NMenuElement_create`),
        new IndexReference(
            `/apis/classes/NMenuElement`, 
            `4.7.X - NMenuElement`, 
            `method static NMenuElement::ptr NMenuElement::create(const std::string& label, std::vector<NMenuItem>&& items)`, 
            `method__NMenuElement_create`),
        new IndexReference(
            `/apis/classes/NRadioGroupElement`, 
            `4.7.X - NRadioGroupElement`, 
    ...
    new IndexEntry("items", [
        new IndexReference(
            `/apis/classes/NMenuElement`, 
            `4.7.X - NMenuElement`, 
            `property NMenuElement::items`, 
            `property__NMenuElement_items`),
    ]),
    new IndexEntry("key", [
        new IndexReference(
            `/apis/structs`, 
    ...
    new IndexEntry("NMenuElement", [
        ...
        new IndexReference(
            `/apis/classes/NMenuElement`, 
            `4.7.X - NMenuElement`, 
            `method NMenuElement::NMenuElement(const std::string &label, const std::vector<NMenuItem>& items)`, 
            `method__NMenuElement_NMenuElement`),
        new IndexReference(
            `/apis/classes/NMenuElement`, 
            `4.7.X - NMenuElement`, 
            `method NMenuElement::NMenuElement(const std::string &label, std::vector<NMenuItem>&& items)`, 
            `method__NMenuElement_NMenuElement`),
    ]),
...
let keywordIndexMap = new Map<string,IndexLink>([
    ...
    ["NWindow::add_child_window", {route: "/apis/classes/NWindow", id: "method__NWindow_add_child_window", classRef: false}],
    ...
    ["NMenuElement::items", {route: "/apis/classes/NMenuElement", id: "property__NMenuElement_items", classRef: false}],
    ...
    ["NColorPair::operator==", {route: "/apis/classes/NColorPair", id: "method__NColorPair_operator==", classRef: false}],
